...
def calculate_total(feet_ordered, price_per_foot):
    return feet_ordered * price_per_foot


def calculate_price_per_foot(amount_ordered):
...
def get_order_details():
    ...
    while quantity <= 0:
        try:
            ...
            price = calculate_price_per_foot(quantity)
